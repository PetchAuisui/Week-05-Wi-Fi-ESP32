...
| :---------: | :--------------- | :---------------------------------------------: | :----------------------------------------: | :--------: | :--------------------------------------------------- |
|  **5.4.1**  | Password ถูกต้อง |                    เกิดขึ้น                     |                  เกิดขึ้น                  | **Passed** | N/A (เชื่อมต่อและรับ IP สำเร็จสมบูรณ์)               |
|  **5.4.2**  | Password ผิด     |        ไม่เกิด (เนื่องจากเป็น WPA3-SAE)         |                  ไม่เกิด                   | **Failed** | Decimal `202` / Hex `0xCA` (`WIFI_REASON_AUTH_FAIL`) |
